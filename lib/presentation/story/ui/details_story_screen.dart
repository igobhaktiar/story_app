  ...
  void _addComment() {
    if (_commentFormKey.currentState?.validate() ?? false) {
      ...
      context.read<StoryBloc>().add(StoryUpdateEvent(StoryModel(
            ...
            comments: List.from(widget.storyModel?.comments ?? [])..add(comment),
          )));
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: NetworkImage(widget.storyModel?.images ?? ''),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(
                          widget.storyModel?.comments?.length.toString() ?? '0',
                          style: cardBodyTextStyle,
                        ),
                        Text(
                          ' Comments',
